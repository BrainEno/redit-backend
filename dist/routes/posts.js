    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (title.trim() === "") {
                    return [2, res.status(400).json({ title: "标题不得为空" })];
                }
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4, Sub_1.default.findOneOrFail({ name: sub })];
            case 2:
                subRecord = _b.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [2, res.json(posts)];
            case 3:
                err_2 = _a.sent();
                console.log(err_2);
                return [2, res.json({ error: "有什么地方出错了" })];
            case 4: return [2];
        }
    });
}); };
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                err_3 = _b.sent();
                console.log(err_3);
                return [2, res.status(404).json({ error: "未找到该贴文" })];
            case 4: return [2];
        }
    });
}); };
var commentOnPost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                _b.sent();
                return [2, res.json(comment)];
            case 4:
                err_4 = _b.sent();
                console.log(err_4);
                return [2, res.status(404).json({ error: "未找到该帖文" })];
            case 5: return [2];
        }
    });
}); };
var getPostComments = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                post = _b.sent();
                return [4, Comment_1.default.find({
                        where: { post: post },
                        order: { createdAt: "DESC" },
                        relations: ["votes"],
                    })];

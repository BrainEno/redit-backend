        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (class_validator_1.isEmpty(title))
                    errors.title = "标题不得为空";
                return [4, typeorm_1.getRepository(Sub_1.default)
            ...
            case 3:
                err_1 = _b.sent();
                return [2, res.status(400).json(err_1)];
            case 4:
                _b.trys.push([4, 6, , 7]);
            ...
            case 5:
                _b.sent();
                return [2, res.json(sub)];
            case 6:
                err_2 = _b.sent();
                console.log(err_2);
                return [2, res.status(500).json({ errors: "有什么地方出错了" })];
            case 7: return [2];
        }
    });
}); };
var getSub = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4, Sub_1.default.findOneOrFail({ name: name })];
            case 2:
                sub = _a.sent();
                return [4, Post_1.default.find({
                        where: { sub: sub },
            ...
            case 4:
                err_3 = _a.sent();
                console.log(err_3);
                return [2, res.status(404).json({ sub: "没有发现贴文" })];
            case 5: return [2];
        }
    });
}); };
var ownSub = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, Sub_1.default.findOneOrFail({ where: { name: req.params.name } })];
            case 2:
                sub = _a.sent();
                if (sub.username !== user.username) {
                    return [2, res.status(403).json({ error: "您不是该小组的管理员" })];
                }
                res.locals.sub = sub;
                return [2, next()];
            case 3:
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (type !== "image" && type !== "banner") {
                    ...
                    return [2, res.status(400).json({ error: "类型无效" })];
                }
                oldImageUrn = "";
                if (type === "image") {
...
var searchSubs = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, subs, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                name_1 = req.params.name;
                if (class_validator_1.isEmpty(name_1)) {
                    return [2, res.status(400).json({ error: "名称不得为空" })];
                }
                return [4, typeorm_1.getRepository(Sub_1.default)
                        .createQueryBuilder()
                        .where("LOWER(name) LIKE :name", {
                        name: name_1.toLowerCase().trim() + "%",
                    })
                        .getMany()];
            case 1:
                subs = _a.sent();

    ...
    CreateData.prototype.run = function (_, connection) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, bcryptjs_1.default.hash("123456", 6)];
                    case 1:
                        password = _a.sent();
                        minute = 1000 * 60;
                        hour = minute * 60;
                    ...
                    case 2:
                        _a.sent();
                        return [4, User_1.default.findOne({ username: "john" })];
                    case 3:
                        john = _a.sent();
                        return [4, User_1.default.findOne({ username: "jane" })];
                    case 4:
                        jane = _a.sent();
                        return [4, connection
                                .createQueryBuilder()
                    ...
                    case 5:
                        _a.sent();
                        return [4, Sub_1.default.findOne({ where: { name: "reactjs" } })];
                    case 6:
                        reactJsSub = _a.sent();
                        return [4, Sub_1.default.findOne({ where: { name: "funny" } })];
                    case 7:
                        funnySub = _a.sent();
                        return [4, Sub_1.default.findOne({ where: { name: "InsightfulQuestions" } })];
                    case 8:
                        iqSub = _a.sent();
                        return [4, Sub_1.default.findOne({ where: { name: "oneliners" } })];
                    case 9:
                        oneliners = _a.sent();
                        return [4, connection
                                .createQueryBuilder()
                    ...
                    case 10:
                        _a.sent();
                        return [4, Post_1.default.findOne(6)];
                    case 11:
                        post6 = _a.sent();
                        return [4, Post_1.default.findOne(7)];
                    case 12:
                        post7 = _a.sent();
                        return [4, Post_1.default.findOne(8)];
                    case 13:
                        post8 = _a.sent();
                        return [4, Post_1.default.findOne(9)];
                    case 14:
                        post9 = _a.sent();
                        return [4, connection
                                .createQueryBuilder()
                    ...
                    case 15:
                        _a.sent();
                        return [4, Comment_1.default.findOne(1)];
                    case 16:
                        comment1 = _a.sent();
                        return [4, Comment_1.default.findOne(2)];
                    case 17:
                        comment2 = _a.sent();
                        return [4, connection
                                .createQueryBuilder()
